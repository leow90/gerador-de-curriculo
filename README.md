...
<body>
    <div class="container mt-5">
        ...
        <?php if ($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
            ...
            <div class="container mt-5">
                <h2 class="text-center">Currículo de <?php echo $name; ?></h2>
                <hr>
                ...
                <?php foreach ($companies as $index => $company): ?>
                    <div class="experience-entry">
                        ...
                        <p><strong>Cargo:</strong> <?php echo htmlspecialchars($roles[$index]); ?></p>
                        <p><strong>Duração:</strong> <?php echo htmlspecialchars($durations[$index]); ?></p>
                        <hr>
                    </div>
                <?php endforeach; ?>
            </div>
